...
hummingbird ring object.builder create 10 1 168
hummingbird ring object.builder add r1z1-127.0.0.1:6000/aio 1
hummingbird ring object.builder rebalance

hummingbird ring container.builder create 10 1 168
hummingbird ring container.builder add r1z1-127.0.0.1:6001/aio 1
hummingbird ring container.builder rebalance

hummingbird ring account.builder create 10 1 168
